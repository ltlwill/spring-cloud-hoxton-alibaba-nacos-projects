 ...
 */
@Component
public class ZuulForwardPreFilter extends ZuulFilter {

	private static final Logger logger = LoggerFactory.getLogger(ZuulForwardPreFilter.class);
	...
	private void setTransferUserInfo() {
		logger.debug("UserInfoPreSettingFilter setTransferUserInfo...");
		try {
